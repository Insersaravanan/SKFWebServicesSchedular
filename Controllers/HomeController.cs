...
namespace SKFWebServicesSchedular.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //var client1 = new RestClient("https://api-idap.infinite-uptime.com/api/2.0/admin/getMonitorsByPlantId");
            //client1.Timeout = -1;
            ...
            //foreach (MonitorsViewModel uivm in response)
            //{
            //    MonitorsRepo.SaveOrUpdate(uivm);
            //}
           
            // return Content(response1.Content);
